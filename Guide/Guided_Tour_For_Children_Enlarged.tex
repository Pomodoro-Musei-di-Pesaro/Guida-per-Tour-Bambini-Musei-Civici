...
\begin{document}
	\begin{flushleft}
		...
		\LARGE{Questa documentazione è un supporto volto a formare e facilitare gli Operatori Museali, nel far comprendere ai bambini le opere ed il contenuto degli spettacoli della Sonosfera,(che sono visibili all'interno dei Musei Civici), attraverso un Tour guidato da noi appositamente elaborato.}
		\newpage
		...
		Durante la spiegazione sottolineare il dettaglio della {\bfseries Colomba} {\bfseries(che rappresenta lo Spirito Santo)}, presentene nel pannello centrale contenente la scena dell'Incoronazione della Vergine, ha alle sue spalle, come sfondo, la celebre Rocca di Gradara; è altrettanto importante far notare il dettaglio del {\bfseries Drago} in \textit{S. Giorgio e il Drago}, presente in basso tra i sette riquadri della predella.\par
		\begin{minipage}{\linewidth}
			\centering
