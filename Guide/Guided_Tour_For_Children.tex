...
\begin{document}
	\begin{flushleft}
		...
		\begin{enumerate}
			...
			\item Far visionare, nella \textbf{Collezione Mosca}, il pregiato \textit{specchio in vetro di Murano} decorato con \textbf{incisioni d'uva d'argento}; gli \textbf{oggetti in avorio e madreperla}; lo \textit{Stipo con vedute di Roma} sottolineando come queste volessero essere una sorta di \textbf{cartolin
				\begin{minipage}{0.4\linewidth}
				...
				\end{minipage}e} di Roma da mostrare ai commensali e l'\textit{Orologio Notturno},usato dalla marchesa Toschi Mosca per comprendere che ore fossero quando si svegliava in preda all'insonnia.\par
			\begin{minipage}{\linewidth}
				\centering
			\end{minipage}
			...
			\begin{adjustwidth}{-30mm}{0mm}
				\begin{minipage}{\linewidth}
					...
					\end{minipage}
					\hfill
					\begin{minipage}[t] {0.4\linewidth}\right) 
