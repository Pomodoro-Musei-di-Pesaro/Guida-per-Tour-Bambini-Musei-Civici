...
\section{Schema posizionamento Opere all'interno del Museo}
	...
	\begin{frame}{\numcirc{4} Spiegare gli elementi che contraddistinguono la Collezione Rossini}
		\begin{itemize}
			\item Spiegare gli elementi che contraddistinguono la scelta delle opere della  \textbf{Collezione Rossini}; come il \textit{Rosso vermiglio} e \textit{l'oro ed i gioielli} nei dipinti.\par \bigskip
			\begin{minipage}{\linewidth}
				\centering
