...
\begin{document}
		...
		\begin{minipage}{\linewidth}
			\fbox{
				\begin{minipage} [l] [\dimexpr 0.430\textwidth \relax] [t] {\dimexpr .460\textwidth \relax}
					...
					\centering
					\begin{tikzpicture}
						\node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[scale=0.047]{Bellini_Giovanni-Incoronazione_della_Vergine.jpg}};
						\begin{scope}[x={(image.south east)},y={(image.north west)}]
							\draw[draw=none,fill=white] (0,0) rectangle (0.21,0.31);
							\draw[draw=none,fill=white] (0.2,0) rectangle (0.51,0.11);
							\draw[draw=none,fill=white] (0,0.3) rectangle (0.11,0.41);
		...
		\begin{minipage}{\linewidth}
			\fbox{
				\begin{minipage} [l] [\dimexpr 0.430\textwidth \relax] [t] {\dimexpr .460\textwidth \relax}
					...
					\centering
					\begin{tikzpicture}
						\node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[scale=0.034]{Vitale_da_Bologna-Santo_Ambrogio_in_trono.jpg}};
						\begin{scope}[x={(image.south east)},y={(image.north west)}]
							\draw[draw=none,fill=white] (0,0) rectangle (0.21,0.31);
							\draw[draw=none,fill=white] (0.2,0) rectangle (0.51,0.11);
							\draw[draw=none,fill=white] (0,0.3) rectangle (0.11,0.41);
		...
		\begin{minipage}{\linewidth}
			\fbox{
				\begin{minipage} [l] [\dimexpr 0.430\textwidth \relax] [t] {\dimexpr .460\textwidth \relax}
					...
					\centering
					\begin{tikzpicture}
						\node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[scale=0.04]{Desani_Pietro-Rebecca_ed_Eleazar.jpg}};
						\begin{scope}[x={(image.south east)},y={(image.north west)}]
							\draw[draw=none,fill=white] (0,0) rectangle (0.21,0.31);
							\draw[draw=none,fill=white] (0.2,0) rectangle (0.51,0.11);
							\draw[draw=none,fill=white] (0,0.3) rectangle (0.11,0.41);
		...
		\begin{minipage}{\linewidth}
			\fbox{
				\begin{minipage} [l] [\dimexpr 0.430\textwidth \relax] [t] {\dimexpr .460\textwidth \relax}
					...
					\centering
					\begin{tikzpicture}
						\node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[]{Giovanni_Antonio_Garella-Leda_e_il_cigno.jpg}};
						\begin{scope}[x={(image.south east)},y={(image.north west)}]
							\draw[draw=none,fill=white] (0,0) rectangle (0.21,0.31);
							\draw[draw=none,fill=white] (0.2,0) rectangle (0.51,0.11);
							\draw[draw=none,fill=white] (0,0.3) rectangle (0.11,0.41);
	...
	\fboxrule=2pt{
		\fbox
		{
			\begin{minipage}{\linewidth}
				\centering
				Leda e il Cigno (Giove) di fattura ad opera di Giovanni Antonio Garella.
			\end{minipage}
	}}
		...
		\begin{minipage}{\linewidth}
			\fbox{
				\begin{minipage} [l] [\dimexpr 0.430\textwidth \relax] [t] {\dimexpr .460\textwidth \relax}
					...
					\centering
					\begin{tikzpicture}
						\node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[scale=0.18]{Specchio_di_Murano.jpg}};
						\begin{scope}[x={(image.south east)},y={(image.north west)}]
							\draw[draw=none,fill=white] (0,0) rectangle (0.21,0.31);
							\draw[draw=none,fill=white] (0.2,0) rectangle (0.51,0.11);
							\draw[draw=none,fill=white] (0,0.3) rectangle (0.11,0.41);
		...
		\begin{minipage}{\linewidth}
			\fbox{
				\begin{minipage} [l] [\dimexpr 0.430\textwidth \relax] [t] {\dimexpr .460\textwidth \relax}
					...
					\centering
					\begin{tikzpicture}
						\node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[scale=0.4]{Vedute_di_Roma_1.jpg}};
						\begin{scope}[x={(image.south east)},y={(image.north west)}]
							\draw[draw=none,fill=white] (0,0) rectangle (0.21,0.31);
							\draw[draw=none,fill=white] (0.2,0) rectangle (0.51,0.11);
							\draw[draw=none,fill=white] (0,0.3) rectangle (0.11,0.41);
		...
		\begin{minipage}{\linewidth}
			\fbox{
				\begin{minipage} [l] [\dimexpr 0.430\textwidth \relax] [t] {\dimexpr .460\textwidth \relax}
					...
					\centering
					\begin{tikzpicture}
						\node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[scale=0.15]{Orologio_notturno.jpg}};
						\begin{scope}[x={(image.south east)},y={(image.north west)}]
							\draw[draw=none,fill=white] (0,0) rectangle (0.21,0.31);
							\draw[draw=none,fill=white] (0.2,0) rectangle (0.51,0.11);
							\draw[draw=none,fill=white] (0,0.3) rectangle (0.11,0.41);
		...
		\begin{minipage}{\linewidth}
			\fbox{
				\begin{minipage} [l] [\dimexpr 0.430\textwidth \relax] [t] {\dimexpr .460\textwidth \relax}
					...
					\centering
					\begin{tikzpicture}
						\node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[scale=0.8]{Scacciani_Antonio-Vassoio-Rosa.jpg}};
						\begin{scope}[x={(image.south east)},y={(image.north west)}]
							\draw[draw=none,fill=white] (0,0) rectangle (0.21,0.31);
							\draw[draw=none,fill=white] (0.2,0) rectangle (0.51,0.11);
							\draw[draw=none,fill=white] (0,0.3) rectangle (0.11,0.41);
		...
		\begin{minipage}{\linewidth}
			\fbox{
				\begin{minipage} [l] [\dimexpr 0.430\textwidth \relax] [t] {\dimexpr .460\textwidth \relax}
					...
					\centering
					\begin{tikzpicture}
						\node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[scale=0.034]{Milani_Aureliano-Mercato.jpg}};
						\begin{scope}[x={(image.south east)},y={(image.north west)}]
							\draw[draw=none,fill=white] (0,0) rectangle (0.21,0.31);
							\draw[draw=none,fill=white] (0.2,0) rectangle (0.51,0.11);
							\draw[draw=none,fill=white] (0,0.3) rectangle (0.11,0.41);
		...
		\begin{minipage}{\linewidth}
			\fbox{
				\begin{minipage} [l] [\dimexpr 0.430\textwidth \relax] [t] {\dimexpr .460\textwidth \relax}
					...
					\centering
					\begin{tikzpicture}
						\node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[scale=0.049]{Berentz_Christian-Fiori_e_frutta_con_bicchieri_di_cristallo.jpg}};
						\begin{scope}[x={(image.south east)},y={(image.north west)}]
							\draw[draw=none,fill=white] (0,0) rectangle (0.21,0.31);
							\draw[draw=none,fill=white] (0.2,0) rectangle (0.51,0.11);
							\draw[draw=none,fill=white] (0,0.3) rectangle (0.11,0.41);
		...
		\begin{minipage}{\linewidth}
			\fbox{
				\begin{minipage} [l] [\dimexpr 0.430\textwidth \relax] [t] {\dimexpr .460\textwidth \relax}
					...
					\centering
					\begin{tikzpicture}
						\node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[scale=0.051]{Gianlisi_Antonio_Junior-Trompe_l_oeil_con_sonetto_in_onore_di_Eugenio_di_Savoia_e_mensola_con_oggetti.jpg}};
						\begin{scope}[x={(image.south east)},y={(image.north west)}]
							\draw[draw=none,fill=white] (0,0) rectangle (0.21,0.31);
							\draw[draw=none,fill=white] (0.2,0) rectangle (0.51,0.11);
							\draw[draw=none,fill=white] (0,0.3) rectangle (0.11,0.41);
		...
		\begin{minipage}{\linewidth}
			\fbox{
				\begin{minipage} [l] [\dimexpr 0.430\textwidth \relax] [t] {\dimexpr .460\textwidth \relax}
					...
					\centering
					\begin{tikzpicture}
						\node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[scale=0.050]{Gianlisi_Antonio_Junior-Trompe_l_oeil_con_paesaggio_forbici_e_mensola_con_oggetti.jpg}};
						\begin{scope}[x={(image.south east)},y={(image.north west)}]
							\draw[draw=none,fill=white] (0,0) rectangle (0.21,0.31);
							\draw[draw=none,fill=white] (0.2,0) rectangle (0.51,0.11);
							\draw[draw=none,fill=white] (0,0.3) rectangle (0.11,0.41);
		...
		\begin{minipage}{\linewidth}
			\fbox{
				\begin{minipage} [l] [\dimexpr 0.430\textwidth \relax] [t] {\dimexpr .460\textwidth \relax}
					...
					\centering
					\begin{tikzpicture}
						\node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[scale=0.7]{Realfonzo_Tommaso-Natura_morta_con_dolci_frutta_uova_e_formaggi.jpg}};
						\begin{scope}[x={(image.south east)},y={(image.north west)}]
							\draw[draw=none,fill=white] (0,0) rectangle (0.21,0.31);
							\draw[draw=none,fill=white] (0.2,0) rectangle (0.51,0.11);
							\draw[draw=none,fill=white] (0,0.3) rectangle (0.11,0.41);
		...
		\begin{minipage}{\linewidth}
			\fbox{
				\begin{minipage} [l] [\dimexpr 0.430\textwidth \relax] [t] {\dimexpr .460\textwidth \relax}
					...
					\centering
					\begin{tikzpicture}
						\node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[scale=0.05]{Gessi_Giovan_Francesco-Morte_di_Adone.jpg}};
						\begin{scope}[x={(image.south east)},y={(image.north west)}]
							\draw[draw=none,fill=white] (0,0) rectangle (0.21,0.31);
							\draw[draw=none,fill=white] (0.2,0) rectangle (0.51,0.11);
							\draw[draw=none,fill=white] (0,0.3) rectangle (0.11,0.41);
