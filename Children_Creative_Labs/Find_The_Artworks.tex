				...
				\begin{minipage} [l] [\dimexpr 0.430\textwidth \relax] [t] {\dimexpr .460\textwidth \relax}
					...
					\begin{tikzpicture}
						...
						\begin{scope}[x={(image.south east)},y={(image.north west)}]
							...
							\draw[draw=none,fill=white] (0.9,0.3) rectangle (1.1,0.61);
							\draw[draw=none,fill=white] (0,0.6) rectangle (0.91,0.71);
							\draw[draw=none,fill=white] (0.1,0.5) rectangle (0.21,0.81);
							\draw[draw=none,fill=white] (0.2,0.5) rectangle (0.31,1.1);
							\draw[draw=none,fill=white] (0.4,0.4) rectangle (0.51,1.1);
							\draw[draw=none,fill=white] (0,0.9) rectangle (1.1,1.1);
							...
							\draw[draw=none,fill=white] (0.6,0.8) rectangle (1.1,0.91);
						\end{scope}
					\end{tikzpicture}
